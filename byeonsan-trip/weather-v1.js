(()=>{
  ...
  function applyFirstDayDinner(){
    ...
    if(dinner){
      ...
      dinner.dataset.link="https://naver.me/xTTVxJMX";
    ...
    if(card){
      const a=card.querySelector(".food-card-top");
      card.dataset.mapUrl="https://naver.me/xTTVxJMX";
      if(a)a.href="https://naver.me/xTTVxJMX";
    }
  }
  ...
  setTimeout(applyFirstDayDinner,0);
})();